// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EchoController.cs" company="Bio2hazard">
//   Licensed under GNU GPL v2.0.
//   See License/GPLv2.txt for details.
// </copyright>
// <summary>
//   The Web Api 2 access point for Echo-related interaction. Contains RESTful access to CRUD and other required queries.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
namespace ShortStuff.Web.Controllers
{
    ...
    public class EchoController : BaseController
    {
        ...
        /// <summary>
        /// Asks the service to retrieve a single echo uniquely identified through id.
        /// </summary>
        /// <param name="id">
        ...
        /// <summary>
        /// Asks the service to create a new echo, using the supplied information.
        /// </summary>
        /// <param name="data">
        ...
        /// <summary>
        /// Asks the service to update a existing echo - identified uniquely through their id - using the supplied information. If no echo exists, a new one will be created.
        /// </summary>
        /// <param name="id">
        /// The echos unique identifier.
        /// </param>
        ...
        /// <summary>
        /// Asks the service to delete the echo uniquely identified through Id.
        /// </summary>
        /// <param name="id">
        /// The echos unique identifier.
        /// </param>
